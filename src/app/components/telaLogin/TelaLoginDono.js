...
    try {
      // Chama a API unificada com o tipo "OWNER"
      const data = await login(email, senha, "OWNER");
...
      // Redireciona para o Dashboard do Dono
...
  return (
    // O JSX é idêntico ao do Cliente
